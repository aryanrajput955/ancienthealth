    ...
    const fetchOrders = useCallback(async () => {
        try {
            ...
            const res = await axios.get(
                `${process.env.REACT_APP_API_URL}/api/admin/orders/completed`,
                { headers: { Authorization: `Bearer ${token}` } }
            )
    ...
    return (
        <div className="p-8 min-h-screen bg-slate-50">
            ...
            <div className="mb-8">
                <div className="flex items-center gap-3 mb-1">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-500">Delivered orders — click a status badge to update it</p>
                    </div>
                </div>
            </div>
            ...
            <div className="relative mb-6">
                ...
                <input
                    type="text"
                    placeholder="Search by order #, city, phone..."
                    className="w-full pl-9 pr-4 py-2.5 bg-white border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-green-500 shadow-sm"
                    value={search}
                ...
                {loading ? (
                    <div className="flex flex-col items-center justify-center py-24 gap-3">
                        <div className="relative">
                            ...
                            <div className="animate-spin rounded-full h-12 w-12 border-4 border-green-500 border-t-transparent absolute top-0" />
                        </div>
