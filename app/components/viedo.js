...
export default function VideoSection() {
  ...
  const videos = [
    { title: "Herb Harvesting", src: "https://www.w3schools.com/html/mov_bbb.mp4" },
    { title: "Eco Packaging", src: "https://www.w3schools.com/html/mov_bbb.mp4" },
    { title: "Sacred Rituals", src: "https://www.w3schools.com/html/mov_bbb.mp4" },
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-3xl md:text-5xl lg:text-6xl font-light text-gray-800 mb-4 md:mb-6">
            Where Heritage Meets <span className="italic text-red-700">Modern Excellence</span>
          </h2>
        ...
        <div className="relative">
          ...
          >
            {videos.map((video, index) => {
              ...
              return (
                ...
                >
                  <div className={`w-[280px] md:w-[320px] h-[240px] md:h-[360px] lg:h-[420px] bg-white rounded-xl md:rounded-2xl shadow-xl overflow-hidden cursor-pointer transition-all duration-300 ${
                    hoveredVideo === index && !isDragging ? 'shadow-2xl scale-105' : ''
                  }`}>
                    <div className="h-full relative overflow-hidden">
                      <video
                        ...
                        playsInline
                      />
                      <div className={`absolute inset-0 bg-black/10 duration-300 ${
            ...
            <button 
              onClick={handlePrev}
              className="hidden md:flex absolute left-4 top-1/2 transform -translate-y-1/2 bg-red-700 text-white p-3 rounded-full hover:bg-red-800 transition-all duration-200 z-40 shadow-lg hover:scale-110 items-center justify-center"
            ...
            <button 
              onClick={handleNext}
              className="hidden md:flex absolute right-4 top-1/2 transform -translate-y-1/2 bg-red-700 text-white p-3 rounded-full hover:bg-red-800 transition-all duration-200 z-40 shadow-lg hover:scale-110 items-center justify-center"
          ...
          <div className="flex md:hidden justify-center mt-6 space-x-4">
            <button 
              onClick={handlePrev}
              className="bg-red-700 text-white p-3 rounded-full hover:bg-red-800 transition-all duration-200 shadow-lg active:scale-95"
              aria-label="Previous video"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
          ...
          <div className="fixed inset-0 bg-black bg-opacity-95 z-50 flex items-center justify-center p-4">
            <div className="relative w-full max-w-4xl">
              ...
              <button
                ...
                className="absolute top-4 right-4 bg-red-700 text-white p-2 md:p-3 rounded-full hover:bg-red-800 transition-all duration-200 z-10"
